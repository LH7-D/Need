		...
		function plusClick(code,id)
			{
				...
				success:function(returnData)
				{
					...
					for(var i = 0;i < twoIndustry.length-1;i++)
					{
						...
						if(nextLevel2 == "true")
						{
							nowElement.parent().append("<ul id='"+code2+"ul'><a href='javascript:void(0);' id='"+code2+"p' class='plus2' onclick='plusClick1(\""+code2+"\",\""+code2+"+\");'>+</a><a href='javascript:void(0);' id='"+code2+"m' class='mins2' onclick='minsClick(\""+code2+"\");'>-</a><a href='javascript:void(0);' id='"+code2+"' target='res' onclick='searchLinkClick(\""+code2+"\")'>"+title2+"</a></ul>");
						}
						else
						{
							nowElement.parent().append("<ul id='"+code2+"ul'><a href='javascript:void(0);' id='"+code2+"' target='res' onclick='searchLinkClick(\""+code2+"\")'>"+title2+"</a></ul>");
						}
					}	
					$(".mins2").hide();
				}});
