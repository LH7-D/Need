...
<form action="shenpi_updateType.action" method="post" id="form1">      
<table align="center">
<c:forEach var="xinxi" items="${xinxis }">
 ...
 <tr>
  ...
  <tr>
      ...
      <!-- <td colspan="3">
              <select name="guanli" id="guanli" style="height:100%;width:99%">
             <option value=""></option>
       ...
       <td colspan="3">
            ...
            <select name="guanli" id="guanli">
                 <option></option>
             <s:forEach var="guanli" items="${guanlis }">
		         <option>${guanli.name}</option>
		     </s:forEach>
		    </select>
