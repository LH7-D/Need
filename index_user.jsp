                        ...
                        <div id="bs_bannerright">
                            ...
                            <div class="bs_nav">
                                <div class="bs_navleft">
                                    <li>
                                        <span>
                                        </span>您好！${userInsession.username },今天是
                                        <script>
                        ...
                        <div id="rbox">
                            ...
                            <div id="rbox_middlecenter">
                                <div id="rbox_middleleft">
                                    ...
                                    <!-- ---------大小有关-------------- -->
                                        <div id="bs_right">
                                            <IFRAME scrolling="yes" width="100%" frameBorder=0 id=frmright name=frmright src="temp/open.jsp" allowTransparency="true"  width="300" height="1900">
                                            </IFRAME>
                                        </div>
                                    </div>
                                </div>
