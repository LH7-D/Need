function inputGmjjhy(){
	...
	if(gmjjhy2=="")
	{
		collectform.GMJJHY.value = gmjjhy2.options[gmjjhy2.selectedIndex].text;
	}else if(gmjjhy3 != "")
	{
		collectform.GMJJHY.value = gmjjhy3.options[gmjjhy3.selectedIndex].text;
	}
}
function inputXkfl(){
	...
	if(xkfl3=="")
	{
		collectform.XKFL.value = xkfl2.options[xkfl2.selectedIndex].text;
	}else if(xkfl3 != "")
	{
		collectform.XKFL.value = xkfl3.options[xkfl3.selectedIndex].text;
	}else{
		collectform.XKFL.value ="";
	}
